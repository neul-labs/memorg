...
class MemorgMCP:
    ...
    def _setup_routes(self):
        ...
        # System operations
        self.mcp.add_resource_operation(
            name="create_session",
            description="Create a new Memorg session",
        ...
        self.mcp.add_resource_operation(
            ...
            description="Start a new conversation in a session",
        ...
        self.mcp.add_resource_operation(
            name="add_exchange",
            description="Add a new exchange to a topic",
            resource_type="exchange",
            handler=self._add_exchange
        )
        ...
        self.mcp.add_resource_operation(
            ...
            handler=self._get_memory_usage
        )
        ...
        self.mcp.add_resource_operation(
            ...
            handler=self._optimize_context
        )
    ...
    async def _create_session(self, ctx: Context, user_id: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _start_conversation(self, ctx: Context, session_id: str) -> Dict[str, Any]:
    ...
    async def _add_exchange(self, ctx: Context, topic_id: str, user_message: str, system_message: str) -> Dict[str, Any]:
    ...
    async def _search_context(self, ctx: Context, query: str, scope: str = "ALL", max_results: int = 10) -> Dict[str, Any]:
    ...
    async def _get_memory_usage(self, ctx: Context) -> Dict[str, Any]:
    ...
    async def _optimize_context(self, ctx: Context, content: str, max_tokens: int) -> Dict[str, Any]:
